...
INSERT INTO usuario(celular, cpf_cnpj, departamento, dt_criacao, email, nome, password, rg, saldo, status, telefone, tipo_pessoa, instituicao_id, orientador_id, endereco, cidade, uf, cep) VALUES ('9999-8888', '12345678999', 'depto', CURRENT_DATE, 'tecnico@tecnico.com', 'Tecnico', '$2a$10$.PVIfB07x.SfMYTcToxL0.yxcLWU0GbS2NUO1W1QAvqMm/TsFhVem', '1234', 0.0, 'STATS', 'aa', 'aa', null, null,'Av. Tupi, 123, Centro', 'Pato Branco', 'Parana', '022221111');
